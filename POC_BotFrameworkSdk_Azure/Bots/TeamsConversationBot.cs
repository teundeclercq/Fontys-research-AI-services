    ...
    public class TeamsConversationBot : TeamsActivityHandler
    {
        ...
        private async Task GetSingleCoursesAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var message_response = MessageFactory.Text(text: $"What is your User ID?");
                await turnContext.SendActivityAsync(message_response);
            ...
            /* if (string.Equals(turnContext.Activity.Text, "courses", System.StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            {
                var replyText = $"Echo: {turnContext.Activity.Text}. Say 'courses' to go the .";
                await turnContext.SendActivityAsync(MessageFactory.Text(replyText, replyText), cancellationToken);
            } */
            var responseMessage = turnContext.Activity.Text.Trim().ToLower();
